...
function ltlb_uninstall_cleanup_current_blog(): void {
	...
	$tables = [
		...
		$wpdb->prefix . 'lazy_payment_schedule',
		$wpdb->prefix . 'lazy_coupons',
		$wpdb->prefix . 'lazy_coupon_usage',
		$wpdb->prefix . 'ltlb_cancellation_log',
		$wpdb->prefix . 'ltlb_reschedule_log',
		$wpdb->prefix . 'ltlb_booking_policies',
		$wpdb->prefix . 'ltlb_locations',
		$wpdb->prefix . 'ltlb_location_staff',
		$wpdb->prefix . 'ltlb_location_services',
		$wpdb->prefix . 'ltlb_staff_capacity',
		$wpdb->prefix . 'ltlb_invoices',
		$wpdb->prefix . 'ltlb_form_fields',
		$wpdb->prefix . 'ltlb_appointment_fields',
		$wpdb->prefix . 'ltlb_webhooks',
		$wpdb->prefix . 'ltlb_webhook_logs',
		$wpdb->prefix . 'ltlb_waitlist',
		$wpdb->prefix . 'ltlb_group_bookings',
		$wpdb->prefix . 'ltlb_group_participants',
		$wpdb->prefix . 'ltlb_packages',
		$wpdb->prefix . 'ltlb_package_usage',
		$wpdb->prefix . 'ltlb_notification_queue',
		$wpdb->prefix . 'ltlb_notification_logs',
		$wpdb->prefix . 'ltlb_audit_log',
	];
