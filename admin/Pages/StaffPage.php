...
class LTLB_Admin_StaffPage {
    ...
    public function render(): void {
        ...
        ?>
        <div class="wrap">
            <h1><?php echo esc_html__('Staff', 'ltl-bookings'); ?></h1>

            <p><?php echo esc_html__('Manage staff members and their working hours.', 'ltl-bookings'); ?></p>
                    ...
                    <?php else : ?>
                        <?php foreach ( $staff_users as $u ) : ?>
                            <tr>
                                ...
                                <td><a href="<?php echo esc_attr( admin_url('admin.php?page=ltlb_staff&user_id=' . intval($u->ID)) ); ?>"><?php echo esc_html__('Edit hours', 'ltl-bookings'); ?></a></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
            ...
            <?php if ( $user_id > 0 ) :
                ...
                <form method="post">
                        ...
                        <tbody>
                            <?php for ( $d = 0; $d < 7; $d++ ) :
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label><?php echo esc_html__('Active', 'ltl-bookings'); ?> <input type="checkbox" name="hours[<?php echo $d; ?>][is_active]" value="1" <?php checked( $active ); ?>></label>
                                        <br>
                                        <label><?php echo esc_html__('Start', 'ltl-bookings'); ?> <input type="time" name="hours[<?php echo $d; ?>][start_time]" value="<?php echo esc_attr( substr($start,0,5) ); ?>"></label>
                    ...
                    <?php submit_button( esc_html__('Save Working Hours', 'ltl-bookings') ); ?>
                </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" style="display:inline">
                                            ...
                                            <input type="hidden" name="user_id" value="<?php echo esc_attr( $user_id ); ?>">
                                            <button class="button" type="submit"><?php echo esc_html__('Delete', 'ltl-bookings'); ?></button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <form method="post">
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" name="is_off_day" value="1"></td>
                            </tr>
                            <tr>
                    ...
                    <?php submit_button( esc_html__('Create Exception', 'ltl-bookings') ); ?>
                </form>
            <?php endif; ?>
        </div>
        <?php
